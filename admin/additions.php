...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1><i class="fa fa-th-list"></i>Tabla de Adiciones/Recomendados</h1>
            <p>Agregar,lista,eliminar,editar</p>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
            <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
            <li class="breadcrumb-item active"><a href="dashboard.php">Dashboard</a></li>
            <li class="breadcrumb-item">Tabla de Adiciones/Recomendados</li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0 text-dark">Lista de Adiciones/Recomendados</h1>
                            </div><!-- /.col -->
                            <div class="col-sm-6 text-right">
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ModalAdd">
                                    <i class="fa fa-plus"></i> Insertar Adiciones/Recomendados
                                </button>
                            </div><!-- /.col -->
                ...
                <div class="tile-body">
                    <div class="table-responsive">
                        <table class="table table-hover"style="width:100%">
                            ...
                            <tbody>
<?php foreach ($aditions as $productos) : ?>
                                    <tr>
                                        <td > <?php echo $i++ ?></td>
                                        ...
                                        <td align="center">    
                                            <button  title="Ver" class="btn btn-info btn-small btnVer" 
                                                     ...
                                                     data-adicion="<?php echo $productos['additions']; ?>"                          
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="../includes/sqlinsert/add_additions.php" method="POST" enctype="multipart/form-data">
                ...
                <input type="hidden" id="aditions" name="aditions" value="SI">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-9">
                                        ...
                                        <select title="Adicion" name="adicionEdit" id="adicionEdit" class="form-control" required>   
                ...
                <div class="col-lg-12">
                    <div class="bs-component">
                        <div class="card">
                            ...
                            <div  id="adicionVer" class="card-footer text-muted"></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="bs-component">
                        <div class="card">
                            ...
                            <div  id="adicionDelete" class="card-footer text-muted"></div>
                        </div>
                    </div>
                </div>
            </div>
...
//Preview
    ...
    $(document).ready(function () {
        ...
        $(".btnEliminar").click(function () {
            ...
            $("#adicionDelete").text("Adicion: " + adicion);
        ...
        $(".btnVer").click(function () {
            ...
            $("#adicionVer").text("Adicion :" + adicion);
