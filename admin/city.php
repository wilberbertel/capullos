...
<main class="app-content">
    ...
    <div class="app-title">
        <div>
            <h1><i class="fa fa-th-list"></i>Tabla de ciudades</h1>
        </div>
...
<?php foreach ($citys as $city) : ?>
                                    <tr>
                                        <td > <?php echo $i++ ?></td>
                                        <td > <?php echo $city['name_city']; ?></td>
                                        <td align="center" > <?php if ($city['status'] == "ACTIVE") {
        ?>
    ...
    <?php } ?>
                                        ...
                                        <td align="center">
                                            <button  title="Editar" class="btn btn-primary btn-small btnEditar" 
                                                     ...
                                                     data-nombre="<?php echo $city['name_city']; ?>"
...
<div class="modal fade" id="modalEditar" tabindex="-1" role="dialog" aria-labelledby="modalEditar" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form action="../includes/sqlinsert/update_shippingCity.php?opt=city" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="nombreEdit">Nombre ciudad</label>
...
$("#idEdit").val(idEditar);
        ...
        $(".eliminar").click(function () {
            $.ajax({
                url: '../includes/sqlinsert/delete_shippingCity.php?opt=city',
                method: 'POST',
                data: {
                    id: idEliminar
                }
