                        ...
                        <table class="table table-hover" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td> <?php echo $i++ ?></td>
                                    <td align="center"> <img
                                            src="../uploads/product/<?php echo $productos['image_product']; ?>"
                                            width="25px" height="25px" alt=""></td>
                                    ...
                                    <td align="center"> <?php if ($productos['status'] == "ACTIVE") {
                                        ...
                                        <span class="badge badge-primary"><i
                                                class="fa fa-fw fa-lg fa-check-circle"></i>ACTIVE</span>
                                        <?php } else { ?>
                                        <span class="badge badge-danger"><i
                                                class="fa fa-exclamation-triangle"></i>INACTIVE</span>
                                        <?php } ?>
                                    </td>
                                    <td align="center">
                                        <button title="Ver" class="btn btn-info btn-small btnVer"
                                            ...
                                            data-precio="<?php echo $productos['price']; ?>" data-toggle="modal"
                                            data-target="#modalVer">
                                            <i class="fa fa-eye"></i> </button>
                                    </td>
                                    <td align="center">

                                        <a title="Editar" type="button" class="btn btn-primary btn-small btnEditar"
                                            href="edit_product.php?id=<?php echo $productos['id_product']; ?>">
            ...
            <form action="../includes/sqlinsert/add_product.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input title="Nombre" type="text" onkeyup="javascript:this.value=this.value.toUpperCase();"
                            name="nombre" placeholder="Nombre" id="nombre" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label for="descripcion">Descripcion</label>
                        <textarea title="Descripcion" onkeyup="javascript:this.value=this.value.toUpperCase();" rows="4"
                            cols="50" name="descripcion" placeholder="Descripcion" id="descripcion" class="form-control"
                            required></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="tile">
                            ...
                            <input title="Imagen" type="file" id="imagen" name="imagen" multiple="multiple"
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input title="Precio" type="number" min="0" name="precio" placeholder="100.000"
                                    id="precio" class="form-control" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <a href="categories.php" class="btn btn-primary  btn-small active col-12" role="button"
                                    aria-pressed="true">Ir a Categorias</a>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <a href="occasions.php" class="btn btn-primary  btn-small active col-12" role="button"
                                    aria-pressed="true">Ir a Ocaciones</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="tile">
                            <div class="">
                                <?php foreach ($occasions as $ocaciones) : ?>
                                <label><input type="checkbox" name="ocaciones[]"
                                        value="<?php echo $ocaciones['name_ocaciones']; ?>"><?php echo $ocaciones['name_ocaciones']; ?></label>
                                <!--&ensp;-->
                                <?php endforeach; ?>
                            </div>
                        </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input title="Nombre" type="text" name="nombreEdit"
                            ...
                            id="nombreEdit" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label for="descripcion">Descripcion</label>
                        <textarea title="Descripcion" rows="4" cols="50" name="descripcionEdit"
                            onkeyup="javascript:this.value=this.value.toUpperCase();" placeholder="Descripcion"
                            id="descripcionEdit" class="form-control" required></textarea>
                    </div>
                    <div class="form-group">
                        <label for="imagen">Imagen</label>
                        <div class="col-md-12">
                            <div class="tile">
                                <div class="tile-title-w-btn">
                                    <img title="Imagen" id="imgEdit" name="imgEdit"
                                        style="height: 500px; width: 100%; display: block;" src="" alt="Card image">
                                </div>
                                <!-- <input type="file" name="imagenNew" id="imagenNew" multiple="multiple" class="btn btn-default btn-file" />-->
                                <button title="Editar imagen" type="button" class="btn btn-primary btnEditarImagen"
                                    id="editaImagen">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="input-group-prepend"><span class="input-group-text">$</span></div>
                                <input title="Precio" type="number" min="0" name="precioEdit" placeholder="precio"
                                    id="precioEdit" class="form-control" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-9">
                                <select title="Categoria" name="categoriaEdit" id="categoriaEdit" class="form-control"
                                    required>
                                    <?php foreach ($categories as $categorias) : ?>
                                    <option value="<?php echo $categorias['id_category']; ?>">
                                        <?php echo $categorias['name']; ?></option>'
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-9">
                                <select title="Ocaciones" name="ocacionesEdit" id="ocacionesEdit" class="form-control"
                                    required>
                                    <?php foreach ($occasions as $ocaciones) : ?>
                                    <option value="<?php echo $ocaciones['id_ocaciones']; ?>">
                                        <?php echo $ocaciones['name_ocaciones']; ?></option>
                ...
                <div class="col-lg-12">
                    <div class="bs-component">
                        <div class="card">
                            ...
                            <img id="imgSalida" style="height: 500px; width: 100%; display: block;" src=""
                                alt="Card image">
                            <div class="card-body">
                                <p id="descripcionVer" class="card-text"></p>
                                <h6 class="card-link" id="ocacionVer"></h6>
                            </div>
...
<!-- ModalEditImagen -->
<div class="modal fade" id="modalEditarImagen" tabindex="-1" role="dialog" aria-labelledby="modalEditarImagen"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form action="../includes/sqlinsert/update_image.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="tile">
                        <div class="tile-title-w-btn">
                            <img id="imgEditar" name="imgEditar" style="height: 500px; width: 100%; display: block;"
                                src="" alt="Card image">
                        </div>
                ...
                <div class="col-lg-12">
                    <div class="bs-component">
                        <div class="card">
                            ...
                            <img id="imgSalidaDelete" style="height: 500px; width: 100%; display: block;" src=""
                                alt="Card image">
                            <div class="card-body">
                                <p id="descripcionDelete" class="card-text"></p>
                                <h6 class="card-link" id="ocacionesaDelete"></h6>
                            </div>
