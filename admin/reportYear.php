   ...
   <main class="app-content">
      ...
      <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="#">Reporte de ventas por año</a></li>
        </ul>
        ...
        <div class="col-md-12">
            <div class="tile">
            <form action="reportYear.php" method="POST">
        ...
        <div class="col-md-12" id="seleccion">
          ...
          <section class="invoice" id="seleccion">
              ...
              <div class="row invoice-info">
                ...
                <div class="col-4"><b></b><br><br><b>FECHA DE BUSQUEDA :<?php echo "Año- " .$_POST['año'];?></b><br><b>POR: </b> <?php echo $user['name'];?><br><b>TIPO: </b> <?php echo $user['type'];?></div>
              </div>
              <div class="row">
                <div class="col-12 table-responsive">
                  <table class="table table-bordered" >
                    ...
                    <?php 
                    $total = 0;
                    foreach ($ganaciasAño as $ganaciasAño) : ?>
                     
                      <tr>
                        <td>1</td>
                        <td><?php echo $ganaciasAño['namep'] ?></td>
                        <td><?php echo $ganaciasAño['quantity'] ?></td>
                        <td><?php echo $ganaciasAño['fecha']."".$ganaciasAño['hora'] ?></td>
                        <td><?php echo numberCOP($ganaciasAño['price']) ?></td>
                        <td><?php echo numberCOP($ganaciasAño['total']) ?></td>
                      </tr>
                      <?php 
                       $total=$total+$ganaciasAño['total'];
                    endforeach; ?>
                    </tbody>
                  </table>
                </div>
