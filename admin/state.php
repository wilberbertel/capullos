...
<main class="app-content">
    ...
    <div class="app-title">
        <div>
            <h1><i class="fa fa-th-list"></i>Tabla de departamentos</h1>
        </div>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6 text-right">
                                <button type="button" class="btn btn-primary"  role="link" onclick="window.location = 'shipping_city.php'" >
                                    <i class="fa fa-plus"></i> Insertar nuevo Departamento
                                </button>
                            </div><!-- /.col -->
                        </div><!-- /.row -->
                    </div><!-- /.container-fluid -->
...
<?php foreach ($states as $states) : ?>
                                    <tr>
                                        <td > <?php echo $i++ ?></td>
                                        <td > <?php echo $states['name_state']; ?></td>
                                        <td align="center" > <?php if ($states['status'] == "ACTIVE") {
        ?>
    ...
    <?php } ?>
                                        ...
                                        <td align="center">
                                            <button  title="Editar" class="btn btn-primary btn-small btnEditar" 
                                                     data-id="<?php echo $states['id']; ?>"
                                                     data-nombre="<?php echo $states['name_state']; ?>"
                                                     data-status="<?php echo $states['status']; ?>"
...
<div class="modal fade" id="modalEditar" tabindex="-1" role="dialog" aria-labelledby="modalEditar" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form action="../includes/sqlinsert/update_shippingCity.php?opt=state" method="POST" enctype="multipart/form-data">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalEditar">Editar Departamento</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="nombreEdit">Nombre Departamentos</label>
...
<div class="modal fade" id="modalEliminar" tabindex="-1" role="dialog" aria-labelledby="modalEliminarLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="modalEliminarLabel">Eliminar Departamento</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $(".eliminar").click(function () {
            $.ajax({
                url: '../includes/sqlinsert/delete_shippingCity.php?opt=state',
                method: 'POST',
                data: {
                    id: idEliminar
                }
