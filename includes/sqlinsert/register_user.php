<?php
    include "../load.php";
    if (isset($_POST['firstname']) && isset($_POST['lastname']) && isset($_POST['email']) && isset($_POST['emailConfi'])  
    && isset($_POST['country'])  && isset($_POST['phone']) && isset($_POST['password']) && isset($_POST['passwordConfi'])) {
