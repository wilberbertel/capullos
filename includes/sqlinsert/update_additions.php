...
if (isset($_POST['idEdit']) && isset($_POST['nombreEdit']) && isset($_POST['descripcionEdit']) && isset($_POST['precioEdit']) && isset($_POST['statusEdit']) ) {
    ...
    $session->msg('s', "Adicion actualizado exitosamente. ");
    redirect('../../admin/additions.php', false);
} else {

    $session->msg('d', "No se actualizo  La Adicion. ");
    redirect('../../admin/additions.php', false);
}
