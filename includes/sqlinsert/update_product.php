...
if(isset($_POST['idEdit']) &&  isset($_POST['nombreEdit'])   &&  isset($_POST['descripcionEdit']) &&  isset($_POST['precioEdit'])
    &&  isset($_POST['statusEdit']) &&  isset($_POST['categoriaEdit'])  &&  isset($_POST['ofertaEdit'])){
