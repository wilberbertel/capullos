...
if(isset($_POST['idEdit']) && isset($_POST['namesEdit']) &&  isset($_POST['lasNamesEdit'])   &&  isset($_POST['emailEdit']) &&  isset($_POST['addressEdit'])
    &&  isset($_POST['address2Edit']) &&  isset($_POST['phoneEdit'])  &&  isset($_POST['countryEdit']) &&  isset($_POST['departamentEdit']) &&  isset($_POST['cityEdit'])){
