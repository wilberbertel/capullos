...
$existeOcacion = existOccasions($_GET['name']);
if ($existeOcacion['total']<1 ) {
	$session->msg('d', "No hay ocaciones con ese nombre");
    ...
    if (isset($_GET['name']) && $_GET['name']!="") {
		...
		$productoPorOcacion = productForOccassions($_GET['name']);
...
<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: slideInLeft;">
				...
				<li class="active">Producto Ocacion: <?php echo $_GET['name']?></li>
			</ol>
		</div>
	</div>
    <!--content-->
<div class="products">
	<div class="container">
		<h2>Productos  de la ocacion: <?php echo $_GET['name']?></h2>
		<div class="col-md-9">
		<?php 
			$cont = 0;
			foreach ($productoPorOcacion as  $productos) : 	$cont++; ?>
				...
				<?php endforeach; 
				if($cont==0){
					echo '<h2>No hay productos  de esta ocacion</h2>';
